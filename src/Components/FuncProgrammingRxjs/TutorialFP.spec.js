...
describe('Testing http://reactivex.io/learnrx/', () => {
    ...
    test("Exercise 25: Converting from Arrays to Trees", () => {
        const lists = [
            {
                "id": 5434364,
                "name": "New Releases"
    ...
    test("Exercise 26: Converting from Arrays to Deeper Trees", () => {
        const lists = [
            {
                "id": 5434364,
                "name": "New Releases"
                    ...
                    .concatMap(video => {
                        return Array.zip(
                            ...
                            boxarts
                                ...
                                .reduce((acc, cur) => acc.width * acc.height > cur.width * cur.height ? cur : acc),
                            (time, boxart) => ({id: video.id, title: video.title, time: time.time, boxart: boxart.url })
                        )
                    })
            }))
